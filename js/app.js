...
let particleSystem, snowParticles, maxParticles;
...
function initiate() {
    ...
    snowParticles = new THREE.Geometry;
    ...
    particleSystem = new THREE.ParticleSystem(snowParticles, particleMaterial);
...
function snow() {
    ...
    while(count--){
        let particle = snowParticles.vertices[count];
        if(particle.y < 0){
            particle.y = 100;
            particle.velocity.y = 0;
